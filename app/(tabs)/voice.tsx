...
import { extractTaskFromTranscript, generateTaskGuidance, transcribeAudio } from '@/services/aiService';
...
export default function VoiceScreen() {
  ...
  const [extractedTask, setExtractedTask] = useState<TaskExtraction | null>(null);
  ...
  const createTaskMutation = useMutation({
    mutationFn: async (taskData: TaskExtraction) => {
      const guidance = await generateTaskGuidance(taskData.title, taskData.description);
          ...
          {extractedTask && (
            <View style={styles.extractedSection}>
              ...
              <View style={styles.taskPreview}>
                ...
                <Text style={styles.taskDescription}>{extractedTask.description}</Text>
                <View style={styles.taskMeta}>
                  <View style={[styles.priorityBadge, { backgroundColor: getPriorityColor(extractedTask.priority) }]}>
                    <Text style={styles.priorityText}>{extractedTask.priority.toUpperCase()}</Text>
                  </View>
              ...
              <View style={styles.actions}>
                ...
                <Pressable 
                  style={[styles.createButton, createTaskMutation.isPending && styles.disabledButton]} 
